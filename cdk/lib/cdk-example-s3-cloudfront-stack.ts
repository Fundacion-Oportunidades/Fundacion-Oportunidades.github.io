...
export class InfraStack extends Stack {
  ...
  const domainName = 'oportunidades.org.ar';
          ...
          errorResponses:[
            {
              ...
              // See https://github.com/hashicorp/terraform-provider-aws/issues/7019#issue-395460253
  ...
  // 5. Create a Route 53 alias record for the CloudFront distribution
    ...
    //6. Deploy the files from the 'dist' folder in Github to an S3 bucket
